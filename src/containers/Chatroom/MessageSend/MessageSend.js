...
const MessageSend =(props)=>(
    <>
    <InputGroup style={{width:'400px',marginBottom:'100px',zIndex:"1",position:'relative'}}>
    ...
    <div className="p-2 mb-4 text-right" style={{width: '400px',backgroundColor:'#edefed',position:'absolute', top:'185px'}}>
